...
class _CitizenHomePageState extends State<CitizenHomePage> {
              ...
              children: <Widget>[
                FlatButton(child: Text(name),onPressed: (){
                  if(name =="FAQ"){
                    ...
                    ,arguments: widget.citizen).then((value) {
                    setState(() {
                       _updatecitizeninfo();
                       _getdata();
                    });
                 ...
                 DateTime date=widget.citizen.date.add(Duration(days: 28));
                    ...
                    String dateinstring =widget.day+"/"+widget.month+"/"+widget.year;
                     Navigator.pop(context);
                    Fluttertoast.showToast(
                      msg: 'You have Already taken your first shot,\n Next shot is scheduled to '+dateinstring,
                    ...
                    Navigator.pushNamed(context, Challenges.routename,arguments: widget.citizen).then((value) {
                         setState(() {
                       _updatecitizeninfo();
                       _getdata();
                    });
                  ...
                  Navigator.pushNamed(context, Badges.routename,
                    ...
                    Navigator.pop(context);
                    Fluttertoast.showToast(
                      msg: 'You can avail Certificate after you have vaccinated',
                       toastLength: Toast.LENGTH_LONG,
                        gravity: ToastGravity.CENTER,
                       timeInSecForIosWeb: 1,
                       backgroundColor: Colors.black,
  ...
  void _updatecitizeninfo(){
    ...
    final userdb = FirebaseDatabase.instance.reference();
        userdb.child('citizen/${widget.citizen.mobileno.toString()}').once().then((DataSnapshot data){
      if(data != null){
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(backgroundColor: Colors.black,title: Row(children: <Widget>[
