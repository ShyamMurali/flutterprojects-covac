...
class VaccinatorRegisteration extends StatefulWidget {
  ...
  @override
  _VaccinatorRegisterationState createState() => _VaccinatorRegisterationState();
}
 ...
 List<Company> _companies = Company.getCompanies();
  ...
  void initState() {
    if(widget.vaccinator !=null){
      fbreference.child('vaccinator/${widget.vaccinator.mobileno.toString()}').once().then((DataSnapshot data){
        if(data != null){
...
Navigator.pushReplacementNamed(context, VaccinatorHomepage.routename,arguments: widget.vaccinator);
  ...
  List<DropdownMenuItem<Company>> buildDropdownMenuItems(List companies) {
    ...
    for (Company company in companies) {
      items.add(
        DropdownMenuItem(
          value: company,
          child: Expanded(child: Text(company.name,style: TextStyle(fontSize: 10),)),
        ),
      );
    }
    return items;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Vaccinator Registeration"),
            ...
            children: <Widget>[
               ...
               child: ClipOval(
                 ...
                 SizedBox(height: 20,),
                              ...
                              SizedBox(height: 10,),
                              Text('Enter your reserved place'),
                              SizedBox(height: 10,),
                              Container(
                                width: 400,
                              ...
                              RaisedButton(onPressed: (){
                                ...
                                widget.vaccinator=Vaccinator(
                                 ...
                                 var  vac= widget.vaccinator;
                                  ...
                                  fbreference.child('vaccinator/${widget.vaccinator.mobileno.toString()}').set({
                                    'name':vac.name,
                                    'age':vac.age,
